...
# Load data
train_df = pd.read_csv("data/split_data_preprocessed/train_data_with_summaries.csv", encoding="cp1252", encoding_errors="replace", engine="python") 
test_df = pd.read_csv("data/split_data_preprocessed/test_data_only_summaries.csv", encoding="cp1252", encoding_errors="replace", engine="python")
val_df = pd.read_csv("data/split_data_preprocessed/val_data_with_summaries.csv", encoding="cp1252", encoding_errors="replace", engine="python")
