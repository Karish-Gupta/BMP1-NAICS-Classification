...
#SBATCH -J "industry_sequential_model"         # name of the job
#SBATCH -o industry_sequential_model%j.out     # name of the output file
#SBATCH -e industry_sequential_model%j.err     # name of the error file
